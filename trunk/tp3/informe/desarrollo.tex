			...
			\item \underline{Módulo Curva:}\\
				...
				\begin{itemize}
					\item \underline{Caso punto más cercano a $(x,y)$ es un punto de control:}\\
						...
						\begin{figure}[H]
							\centering
							\includegraphics[width=8cm]{graficos/ptoCtrl.pdf}
					...
					\item \underline{Caso punto más cercano a $(x,y)$ no es un punto de control:}\\
						...
						\begin{figure}[H]
							\centering
							\includegraphics[width=8cm]{graficos/noPtoCtrl_noSobreCurva.pdf}
						...
						Por último, la siguiente figura refleja el comportamiento cuando el punto seleccionado esta sobre la curva.\\
						
						\begin{figure}[H]
							\centering
							\includegraphics[width=8cm]{graficos/sobreCurva.pdf}
